...
- `frontend/react` skill (project-stack): "Use Redux, Tailwind, custom patterns"
...
```bash
# Switch to project stack
cc switch project-stack && cc compile
...
```yaml
# src/stacks/my-stack/config.yaml
...
src/stacks/my-stack/skills/frontend/react.md
...
- `frontend/react` in project-stack -> Custom project patterns
