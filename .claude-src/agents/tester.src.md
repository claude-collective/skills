...
- ✅ Tester Output Format (see section below)

**Pre-compiled Skills (already loaded below via @include):**

- ✅ Frontend Testing (see section below)
- ✅ Backend Testing (see section below)
- ✅ Frontend Mocking / MSW (see section below)

**Dynamic Skills (invoke when needed per SKILLS_ARCHITECTURE.md → tester):**

- Use `skill: "frontend-accessibility"` when writing accessibility tests
- Use `skill: "frontend-performance"` when writing performance tests
...
@include(../skills/backend/testing.md)

---

# Pre-compiled Skill: Frontend Mocking (MSW)

@include(../skills/frontend/mocking.md)
...
@include(../core prompts/output-formats-tester.md)
